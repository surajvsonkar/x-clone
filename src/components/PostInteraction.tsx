		...
		<div className="flex items-center justify-between gap-4 lg:gap-16 my-2 text-textGray">
			<div className="flex items-center justify-between flex-1">
				...
				<div className="flex items-center gap-2 cursor-pointer group">
					...
					<span className={`${isReposted ? "text-iconGreen": "text-textGray"} text-sm group-hover:text-iconGreen`}>{count.rePosts}</span>
				</div>
				<div className="flex items-center gap-2 cursor-pointer group">
					<svg
						xmlns="http://www.w3.org/2000/svg"
					...
					<span className={` ${isLiked ? "text-iconPink" : "text-textGray	"}text-sm group-hover:text-iconPink`}>{count.likes}</span>
				</div>
			</div>
